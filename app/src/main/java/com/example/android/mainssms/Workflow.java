...
public class Workflow extends AppCompatActivity
    ...
    private String TAG = Workflow.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homescreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent homeIntent = new Intent(Workflow.this, Userhome.class);
        ...
        new Workflow.Getconnection(value,tl).execute();
    ...
    public void onBackPressed() {
        new Workflow.Getconnection(value,tl).cancel(true);
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent AccountIntent = new Intent(Workflow.this, Accounts.class);
            startActivity(AccountIntent);
            // Handle the camera action
        } else if (id == R.id.nav_grievance) {
            Intent GrievanceIntent = new Intent(Workflow.this, Grievance.class);
            startActivity(GrievanceIntent);
        } else if (id == R.id.nav_service) {
            Intent ServicesIntent = new Intent(Workflow.this, Services.class);
            startActivity(ServicesIntent);
        } else if (id == R.id.nav_payment) {
            Intent PayementIntent = new Intent(Workflow.this,Self_services.class);
            startActivity(PayementIntent);
        } else if (id == R.id.nav_parking) {
            Intent ParkingIntent = new Intent(Workflow.this,ParkingI.class);
    ...
    private class Getconnection extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            final String[] ret = {""};
            String url = "http://10.42.0.205:8000/employee/grievances/";
           /* url=url+Code+"/";
            url.trim();*/
            //Log.e(TAG, "URL: "+url);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, LOGIN_URL,
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                Toast.makeText(Workflow.this,error.toString(),Toast.LENGTH_LONG ).show();
                            }
                        }){
                    @Override
...
//                    Log.e(TAG, "ab dekh: " + jsonobj.getBoolean("all_attendance_present"));
                    ...
                    if(s) {*/
                        String all_attendanceString = jsonobj.getString("all_entries");
                        ...
                        for(int i=0;i<all_attendanceObject.length();i++){
                            ...
                            Date strDate = sdfDate.parse(jsonObject.getString("created"));
                            Date strDate1 = sdfDate.parse(jsonObject.getString("updated"));
//                            SimpleDateFormat sdfDate1 = new SimpleDateFormat("HH:mm:ss'Z'");
                            /*sdfDate1.format(strDate);
                            sdfDate1.format(strDate1);
*/
                            list.add(jsonObject);
                            ...
                            DateFormat dateFormat = new SimpleDateFormat(
                                    "MMM dd hh:mm ");
                            Datelist.add(jsonObject.getString("category").toUpperCase());
                            checkinlist.add(dateFormat.format(strDate));
                            checkoutlist.add(dateFormat.format(strDate1));
//                            checkoutlist.add(jsonObject.getString("updated").toString());
                           // Log.i(TAG,"@@@@#####@@@@@@@@date is "+dateFormat.format(strDate));
                            //Log.i(TAG,"@@@@@@@@@@@@@@@@@@date is "+sdfDate1.format(strDate));
                        }
...
//
                   ...
                   /* }
                      ...
                      /*  Toast.makeText(Workflow.this,"Failed",Toast.LENGTH_LONG ).show();*/
...
*/
            ...
            companyTV.setLayoutParams(lparams);
